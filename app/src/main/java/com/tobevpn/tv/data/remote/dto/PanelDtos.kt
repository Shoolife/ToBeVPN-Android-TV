...
data class PanelUserDto(
    ...
    @SerializedName("traffic_limit_bytes") val trafficLimitBytes: Long = 0L,
    ...
    @SerializedName("active_internal_squads") val activeInternalSquads: List<PanelSquadRefDto>? = null,
